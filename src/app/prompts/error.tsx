...
export default function PromptsError({
  ...
  // Full error is logged server-side already (Next.js does this for
  // errors thrown in Server Components); this UI only ever shows a
  // friendly message plus a way to recover.
  return (
